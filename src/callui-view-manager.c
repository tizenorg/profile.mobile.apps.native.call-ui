...
static callui_result_e __auto_change_view(callui_vm_h vm)
{
	...
	if (incom) {
		...
		const callui_call_state_data_t *last_call_data = _callui_stp_get_last_ended_call_data(ad->call_stp);
...
static callui_result_e __callui_vm_init(callui_vm_h vm, callui_app_data_t *ad)
{
	...
	callui_result_e res = _callui_stp_add_call_state_event_cb(ad->call_stp,
...
static void __callui_vm_deinit(callui_vm_h vm)
{
	...
	_callui_stp_remove_call_state_event_cb(ad->call_stp, __call_state_event_cb, vm);
